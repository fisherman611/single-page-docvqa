...
from utils.helpers import *  # expects: image_file_to_data_url, clean_json_output, enforce_schema, etc.
...
# Load prompt (OCR-free, no reasoning_type)
...
print(f"Starting augmentation (description + explanation) on {limit}/{total_samples} samples...")
results = []
...
for i in tqdm(range(limit)):
    ...
    try:
        ...
        print(
            f"Generated: {len(image_description)} chars (desc), "
    ...
    # Save progress every 10 successful iterations (by index), plus last
