...
with open("augment_data/explaination_system_prompt.txt", "r", encoding="utf-8") as f:
...
print(f"Starting augmentation (explanation) on {limit}/{total_samples} samples...")
results = []
...
for i in tqdm(range(limit)):
    ...
    try:
        ...
        print(
            f"Generated: {len(answer_explanation)} chars (expl)"
        )
